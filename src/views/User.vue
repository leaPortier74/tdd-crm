<template>
  <router-link to="/dashboard" custom v-slot="{navigate} ">
    <button id="dashboard"  style="margin: 2rem 0; width: 10%; background: linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593);" class="text-white bg-gradient-to-r focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"  @click="navigate" role="link">Return</button>
  </router-link>
  <div class="user">
    
<h1 class="mb-4 mt-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-violet-800 from-red-600">Bienvenue sur votre profile</span></h1>
  ...
  <div>
    <router-link to="/" custom v-slot="{navigate} ">
        <button id="logout" style="margin: 2rem 0; width: 25%; background: linear-gradient(to right, #ee7724, #d8363a, #dd3675, #b44593);" class="text-white to-bl focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"  @click="navigate" role="link">Logout</button>
    </router-link>
  </div>
</template>
